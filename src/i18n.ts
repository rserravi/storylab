...
const dict: Record<Locale, Record<string, string>> = {
  es: {
    ...
    's6.tags.none': 'Sin etiquetas',
    's6.noImage': 'Sin imagen',
    's6.tooltip.createSceneHere': 'Crear escena aquí',
    's6.tooltip.setCover': 'Establecer como portada',
    's6.filter.byTags': 'Filtrar por etiquetas',
    's6.filter.clear': 'Limpiar filtros',
    's6.filter.active': 'filtro activo',
    's6.ai.button': 'Generar Imagen IA',
    's6.ai.modalTitle': 'Generar imagen con IA (mock local)',
    's6.ai.prompt.label': 'Descripción (prompt)',
    's6.ai.prompt.placeholder': 'Ej.: Fachada art déco iluminada con neones, noche lluviosa, travel de cámara…',
    's6.ai.style.label': 'Estilo',
    ...
    's6.aiStyle.cinematic': 'Cinemático',
    's6.aiStyle.noir': 'Noir',
    's6.aiStyle.western': 'Western',
    's6.aiStyle.sciFi': 'Sci-Fi',
    's6.aiStyle.fantasy': 'Fantasy',
    's6.aiStyle.thriller': 'Thriller',
    's6.aiStyle.romance': 'Romance',
    's6.aiStyle.horror': 'Horror',
    's6.aiStyle.animation': 'Animación',
  ...
  en: {
    ...
    's6.tags.none': 'No tags',
    's6.noImage': 'No image',
    's6.tooltip.createSceneHere': 'Create scene here',
    's6.tooltip.setCover': 'Set as cover',
    's6.filter.byTags': 'Filter by tags',
    's6.filter.clear': 'Clear filters',
    's6.filter.active': 'active filter',
    's6.ai.button': 'Generate AI Image',
    's6.ai.modalTitle': 'Generate image with AI (local mock)',
    's6.ai.prompt.label': 'Description (prompt)',
    's6.ai.prompt.placeholder': 'E.g.: Art deco facade lit by neon, rainy night, camera travel…',
    's6.ai.style.label': 'Style',
    's6.ai.note': '(No backend yet) A local **concept** 1024×576 will be generated using the prompt as reference.',
    's6.ai.generate': 'Generate',
    's6.ai.generating': 'Generating…',
    's6.aiStyle.cinematic': 'Cinematic',
    's6.aiStyle.noir': 'Noir',
    's6.aiStyle.western': 'Western',
    's6.aiStyle.sciFi': 'Sci-Fi',
    's6.aiStyle.fantasy': 'Fantasy',
    ...
    's6.aiStyle.romance': 'Romance',
    's6.aiStyle.horror': 'Horror',
    's6.aiStyle.animation': 'Animation',
  ...
  ca: {
    ...
    's6.tags.placeholder': 'Bar, Carretera, Casa…',
    's6.tags.none': 'Sense etiquetes',
    's6.noImage': 'Sense imatge',
    's6.tooltip.createSceneHere': 'Crear escena aquí',
    's6.tooltip.setCover': 'Establir com a portada',
    's6.filter.byTags': 'Filtrar per etiquetes',
    's6.filter.clear': 'Netejar filtres',
    's6.filter.active': 'filtre actiu',
    's6.ai.button': 'Generar Imatge IA',
    's6.ai.modalTitle': 'Generar imatge amb IA (prova local)',
    's6.ai.prompt.label': 'Descripció (prompt)',
    's6.ai.prompt.placeholder': 'Ex.: Façana art déco il·luminada amb neons, nit plujosa, viatge de càmera…',
    's6.ai.style.label': 'Estil',
    's6.ai.note': '(Encara sense backend) Es generarà un **concept** local de 1024×576 amb el prompt com a referència.',
    's6.ai.generate': 'Generar',
    's6.ai.generating': 'Generant…',
    's6.aiStyle.cinematic': 'Cinemàtic',
    's6.aiStyle.noir': 'Noir',
    's6.aiStyle.western': 'Western',
    's6.aiStyle.sciFi': 'Ciència-ficció',
    's6.aiStyle.fantasy': 'Fantasia',
    's6.aiStyle.thriller': 'Thriller',
    's6.aiStyle.romance': 'Romàntic',
    's6.aiStyle.horror': 'Terror',
    's6.aiStyle.animation': 'Animació',
